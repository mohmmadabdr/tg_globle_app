...
class Restaurantcontroller with ChangeNotifier {
  ...
  Future<void> getSearchResults(
    ...
    try {
      ...
      final url = Uri.parse(
        'https://tripadvisor16.p.rapidapi.com/api/v1/restaurant/searchLocation?query=$countriename',
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == true && data['data'] != null) {
          ...
          searchResults = list
              .map((e) => CityRestaurantModel.fromJson(e))
              .toList();
